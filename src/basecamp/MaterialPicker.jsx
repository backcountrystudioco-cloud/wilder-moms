...
const allMaterials = [
  ...
  { id: 'sand', label: 'Sand', icon: '🏖️', category: 'nature' },
  ...
  { id: 'scissors', label: 'Scissors', icon: '✂️', category: 'craft' },
  { id: 'string', label: 'String', icon: '🧵', category: 'craft' },
  { id: 'paint', label: 'Paint', icon: '🎨', category: 'craft' },
  { id: 'markers', label: 'Markers', icon: '🖍️', category: 'craft' },
  { id: 'crayons', label: 'Crayons', icon: '🖊️', category: 'craft' },
  // Food/Nature
  ...
  { id: 'blankets', label: 'Blankets', icon: '🛏️', category: 'craft' },
  ...
  { id: 'blanket', label: 'Blanket', icon: '🛋️', category: 'nature' },
]
