...
export const trailForageItems = [
  { id: 'pinecones', label: 'Pinecones', season: ['spring', 'summer', 'fall'] },
  { id: 'acorns', label: 'Acorns', season: ['fall'] },
  { id: 'feathers', label: 'Feathers', season: ['spring', 'summer', 'fall'] },
  { id: 'smooth_rocks', label: 'Smooth rocks', season: ['spring', 'summer', 'fall', 'winter'] },
  { id: 'flat_rocks', label: 'Flat rocks', season: ['spring', 'summer', 'fall'] },
  { id: 'bark', label: 'Interesting bark', season: ['spring', 'summer', 'fall'] },
  { id: 'leaves_maple', label: 'Maple leaves', season: ['fall'] },
  { id: 'leaves_large', label: 'Large leaves', season: ['spring', 'summer'] },
  { id: 'sticks', label: 'Sticks', season: ['spring', 'summer', 'fall', 'winter'] },
  { id: 'dandelions', label: 'Dandelions', season: ['spring', 'summer'] },
  { id: 'wildflowers', label: 'Wildflowers', season: ['spring', 'summer'] },
  { id: 'moss', label: 'Moss', season: ['spring', 'summer', 'fall'] },
  { id: 'grass_long', label: 'Long grass', season: ['spring', 'summer'] },
  { id: 'seed_pods', label: 'Seed pods', season: ['summer', 'fall'] },
];

// Seasonal forage highlights
export const seasonalForage = {
  spring: [
    { id: 'dandelions', label: 'Dandelions' },
    { id: 'wildflowers', label: 'Wildflowers' },
    { id: 'sticks', label: 'Sticks' },
    { id: 'moss', label: 'Moss' },
    { id: 'grass_long', label: 'Long grass' },
  ],
  summer: [
    { id: 'pinecones', label: 'Pinecones' },
    { id: 'feathers', label: 'Feathers' },
    { id: 'smooth_rocks', label: 'Smooth rocks' },
    { id: 'leaves_large', label: 'Large leaves' },
    { id: 'moss', label: 'Moss' },
  ],
  fall: [
    { id: 'pinecones', label: 'Pinecones' },
    ...
    { id: 'feathers', label: 'Feathers' },
    { id: 'leaves_maple', label: 'Maple leaves' },
    { id: 'sticks', label: 'Sticks' },
    { id: 'seed_pods', label: 'Seed pods' },
  ],
  winter: [
    { id: 'sticks', label: 'Sticks' },
    { id: 'smooth_rocks', label: 'Smooth rocks' },
    { id: 'bark', label: 'Interesting bark' },
    { id: 'pinecones', label: 'Pinecones' },
  ],
};
